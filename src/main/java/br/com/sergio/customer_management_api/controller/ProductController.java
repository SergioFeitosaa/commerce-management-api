...
public class ProductController {
    ...
    @Operation(summary = "Create a new product", description = "Create a new product with name, description and price")
    ...
    @Operation(summary = "List all products", description = "Retrieve a paginated list of registered products")
    @ApiResponse(responseCode = "200", description = "Retrieve a paginated and sorted list of registered products")
    @GetMapping
    ...
    @Operation(summary = "Deactivate product", description = "Deactivate an existing product by its unique identifier")
    @ApiResponse(responseCode = "200", description = "Product deactivated successfully")
    @ApiResponse(responseCode = "404", description = "Deactivate an existing product without deleting it from the database")
    ...
    @Operation(summary = "Activate product", description = "Activate an existing product by its unique identifier")
